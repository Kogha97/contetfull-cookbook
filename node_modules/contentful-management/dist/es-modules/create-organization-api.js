...
export default function createOrganizationApi(makeRequest) {
  const _entities$appDefiniti = entities.appDefinition,
  ...
  const _entities$user = entities.user,
    wrapUser = _entities$user.wrapUser,
    wrapUserCollection = _entities$user.wrapUserCollection;
  const _entities$organizatio = entities.organizationMembership,
  ...
  const _entities$teamMembers = entities.teamMembership,
  ...
  const _entities$teamSpaceMe = entities.teamSpaceMembership,
  ...
  const _entities$team = entities.team,
    wrapTeam = _entities$team.wrapTeam,
    wrapTeamCollection = _entities$team.wrapTeamCollection;
  const _entities$spaceMember = entities.spaceMembership,
  ...
  const wrapOrganizationInvitation = entities.organizationInvitation.wrapOrganizationInvitation;
  const wrapAppUpload = entities.appUpload.wrapAppUpload;
  const wrapAppSigningSecret = entities.appSigningSecret.wrapAppSigningSecret;
  const wrapAppEventSubscription = entities.appEventSubscription.wrapAppEventSubscription;
  const _entities$appKey = entities.appKey,
    wrapAppKey = _entities$appKey.wrapAppKey,
    wrapAppKeyCollection = _entities$appKey.wrapAppKeyCollection;
  const wrapAppDetails = entities.appDetails.wrapAppDetails;
  const _entities$appAction = entities.appAction,
