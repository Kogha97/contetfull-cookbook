...
import { CreateCommentParams, CreateCommentProps, DeleteCommentParams, CommentProps, UpdateCommentParams, UpdateCommentProps, GetManyCommentsParams, RichTextBodyFormat, RichTextCommentProps, PlainTextBodyFormat, RichTextCommentBodyPayload, GetCommentParentEntityParams } from './entities/comment';
...
import { AccessTokenProp, CreatePersonalAccessTokenProps as CreatePATProps } from './entities/access-token';
...
import { CreateWebhooksProps, UpsertWebhookSigningSecretPayload, WebhookCallDetailsProps, WebhookCallOverviewProps, WebhookHealthProps, WebhookProps, WebhookRetryPolicyPayload, WebhookRetryPolicyProps, WebhookSigningSecretProps } from './entities/webhook';
...
import { AppEventSubscriptionProps, CreateAppEventSubscriptionProps } from './entities/app-event-subscription';
...
export type GetSpaceEnvironmentUploadParams = GetSpaceEnvironmentParams & {
    uploadId: string;
};
...
export type GetAppKeyParams = GetAppDefinitionParams & {
    fingerprint: string;
};
